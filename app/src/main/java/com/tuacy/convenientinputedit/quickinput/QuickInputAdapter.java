...
public class QuickInputAdapter extends RecyclerView.Adapter<QuickInputAdapter.ItemHolder> {
	...
	public ItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
		ItemHolder itemHolder = new ItemHolder(
			LayoutInflater.from(parent.getContext()).inflate(R.layout.item_quick_input_content, parent, false));
	...
	static class ItemHolder extends RecyclerView.ViewHolder {
		...
		ItemHolder(View itemView) {
			super(itemView);
			mTextItem = itemView.findViewById(R.id.text_item_shortcut_content);
		}
	}
